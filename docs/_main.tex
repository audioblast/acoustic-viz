...
The majority of the plotting performed for cyclical plots in \texttt{SonicScrewdriver} is performed by the \texttt{radialPolygon()} function. This function can be used to plot sectors, annuli, horizon plots and irregular polygons. If you wish to customise cyclical plots beyond what the helper functions such as \texttt{dielRings()} allow then it is likely that \texttt{radialPolygon()} is the tool you need.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{plotrix}\SpecialCharTok{::}\FunctionTok{radial.plot}\NormalTok{(}
  \AttributeTok{lengths=}\DecValTok{0}\NormalTok{,}
  \AttributeTok{radial.pos=}\DecValTok{0}\NormalTok{,}
  \AttributeTok{rp.type=}\StringTok{"p"}\NormalTok{,}
  \AttributeTok{radial.lim=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{),}
  \AttributeTok{start=}\NormalTok{pi,}
  \AttributeTok{label.pos =} \FunctionTok{dielLabels}\NormalTok{(}\AttributeTok{pos=}\StringTok{\textquotesingle{}pos\textquotesingle{}}\NormalTok{)}\SpecialCharTok{*}\NormalTok{pi}\SpecialCharTok{/}\DecValTok{180}\NormalTok{,}
  \AttributeTok{labels=}\FunctionTok{dielLabels}\NormalTok{(),}
  \AttributeTok{clockwise=}\NormalTok{T,}
  \AttributeTok{poly.col=}\FunctionTok{rgb}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{, }\FloatTok{0.6}\NormalTok{),}
  \AttributeTok{lty=}\DecValTok{0}\NormalTok{,}
  \AttributeTok{show.grid.labels =}\NormalTok{ F)}

\FunctionTok{radialPolygon}\NormalTok{(pi}\SpecialCharTok{/}\DecValTok{6}\NormalTok{,pi}\SpecialCharTok{/}\DecValTok{3}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{2}\NormalTok{,}\AttributeTok{col=}\StringTok{"red"}\NormalTok{)}
\FunctionTok{radialPolygon}\NormalTok{(pi}\SpecialCharTok{/}\DecValTok{2}\NormalTok{,pi,}\FloatTok{1.75}\NormalTok{,}\DecValTok{2}\NormalTok{, }\AttributeTok{col=}\StringTok{"blue"}\NormalTok{)}

\NormalTok{wave }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.5}\NormalTok{,}\FloatTok{0.25}\NormalTok{,}\DecValTok{0}\NormalTok{,}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.5}\NormalTok{,}\FloatTok{0.25}\NormalTok{)}
\NormalTok{angs }\OtherTok{\textless{}{-}}\NormalTok{ pi }\SpecialCharTok{+} \DecValTok{1}\SpecialCharTok{:}\DecValTok{8} \SpecialCharTok{*}\NormalTok{ pi}\SpecialCharTok{/}\DecValTok{16}
\FunctionTok{radialPolygon}\NormalTok{(}\ConstantTok{NA}\NormalTok{,angs,}\DecValTok{1}\NormalTok{,}\FloatTok{1.25}\SpecialCharTok{+}\NormalTok{wave, }\AttributeTok{col=}\StringTok{"orange"}\NormalTok{)}
\NormalTok{angs }\OtherTok{\textless{}{-}}\NormalTok{ angs}\SpecialCharTok{+}\NormalTok{ pi}\SpecialCharTok{/}\DecValTok{2}
\FunctionTok{radialPolygon}\NormalTok{(angs,angs,}\DecValTok{1}\SpecialCharTok{+}\FunctionTok{rev}\NormalTok{(wave), }\FloatTok{1.25}\SpecialCharTok{+}\NormalTok{wave, }\AttributeTok{col=}\StringTok{"green"}\NormalTok{)}

\FunctionTok{legend}\NormalTok{(}
  \SpecialCharTok{{-}}\DecValTok{3}\NormalTok{,}\FloatTok{2.5}\NormalTok{,}
  \FunctionTok{c}\NormalTok{(}\StringTok{"sector"}\NormalTok{, }\StringTok{"annulus"}\NormalTok{, }\StringTok{"horizon"}\NormalTok{, }\StringTok{"polygon"}\NormalTok{),}
  \AttributeTok{col=}\FunctionTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"blue"}\NormalTok{, }\StringTok{"orange"}\NormalTok{, }\StringTok{"green"}\NormalTok{),}
