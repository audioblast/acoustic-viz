...
```{r radialPolygon-types, fig.height=7, fig.width=9, fig.cap='Types of radial polygon plot', fig.align='center', out.width='90%', echo=FALSE}
emptyDiel()
...
```{r radialPolygon-sector, fig.height=7, fig.width=9, fig.cap='Plotting a sector', fig.align='center', out.width='90%'}
emptyDiel()
...
```{r radialPolygon-sector2, fig.height=7, fig.width=9, fig.cap='Plotting a sector', fig.align='center', out.width='90%'}
emptyDiel()
...
```{r radialPolygon-annuli, fig.height=7, fig.width=9, fig.cap='Plotting an annulus and an annular sector', fig.align='center', out.width='90%'}
emptyDiel()
...
```{r radialPolygon-horizon, fig.height=7, fig.width=9, fig.cap='Plotting a horizon polygon.', fig.align='center', out.width='90%'}
library(tuneR)
...
```{r radialPolygon-horizon2, fig.height=7, fig.width=9, fig.cap='Plotting a horizon polygon.', fig.align='center', out.width='90%'}
library(tuneR)
...
```{r emptyYearly, fig.height=7, fig.width=9, fig.cap='An empty yearlyPlot().', fig.align='center', out.width='90%'}
