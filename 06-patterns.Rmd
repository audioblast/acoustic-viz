...
```{r, twilights, fig.asp=0.6875, fig.width=6, fig.cap='Different types of twilight as the sun sets below the horizon', fig.align='center', out.width='90%', echo=FALSE}
plot.default(
  NULL, 
  NULL, 
  xlim=c(-0.2,1.4),
...
In addition to the `date`, `lat` and `lon` parameters to `dieplPlot()` it is possible to make additional customisations to how the information is presented.
